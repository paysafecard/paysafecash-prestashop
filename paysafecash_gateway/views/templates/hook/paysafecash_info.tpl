...
<h3>{l s='Your order on %s is complete.' sprintf=$shop_name mod='paysafecash'}</h3>
<p>
	...
	<br /><br />{l s='An email has been sent with this information.' mod='paysafecash'}
...
{else}
<h3>{l s='Your order on %s has not been accepted.' sprintf=$shop_name mod='paysafecash'}</h3>
<p>
	<br />- {l s='Reference' mod='paysafecash'} <span class="reference"> <strong>{$reference|escape:'html':'UTF-8'}</strong></span>
